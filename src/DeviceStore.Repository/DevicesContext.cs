...
public partial class DevicesContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F67F146B70").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E718C211C56").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E38463ED06C").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D10534BA99ABA2").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F65AAD3B2E").IsUnique();
